    ...
    <div class="container parallax-container">
        ...
        <div class="parallax-captions">
            <div class="parallax-caption">
                <?php echo $total_bundles; ?> bundles
            </div>
            <div class="parallax-caption">
                <?php echo $total_courses; ?> courses
            </div>
            <div class="parallax-caption">
                More than <?php echo $total_length; ?> hours of classes
            </div>
        </div>
    </div>
</div>
            ...
            <div class="gallery">
                ...
                <div class="gallery-items">
                    <div class="gallery-items-area">
                        ...
                        >
                            ...
                            <div class="gallery-item-content">
                                <div class="gallery-item-header">
                                    <?php echo $bundle['bundle']->getName(); ?>
                                </div>
                                <div class="gallery-item-body">
                                    <p>
                                        <?php echo $bundle['bundle']->getDescription(); ?>
                                    </p>
                                </div>
                        ...
                        <?php if(!$bundles->hasNext()): break; ?>
                        <?php endif ?>
                        <?php $bundle = $bundles->next() ?>
                        <?php endwhile; ?>
                    </div>
                </div>
            </div>
