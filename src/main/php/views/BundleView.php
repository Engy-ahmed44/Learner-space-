        ...
        <div class="view_content">
            ...
            <table class="bundle-details">
                ...
                <tr>
                    ...
                    <td>
                        <?php echo number_format($total_length / 60, 2); ?>h
                    </td>
                </tr>
            </table>
                    ...
                    <?php foreach ($courses as $course): ?>
                        <div class="mosaic-item">
                            ...
                            <div class="mosaic-item-content">
                                <div class="mosaic-item-header">
                                    <?php echo $course->getName(); ?>
                                </div>
                                <div class="mosaic-item-caption">
                                    <div class="mosaic-item-caption-split">
                                        <p>
                                            &#128249; <?php echo $course->getTotalClasses(); ?>
                                        </p>
                                        <p>
                                            &#128337; <?php echo number_format($course->getTotalLength() / 60, 2); ?>h
                                        </p>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="purchase-option">
                ...
                <div class="purchase-price">
                    US$ <?php echo number_format($bundle->getPrice(), 2); ?>
                </div>
                ...
                <?php else: ?>
                    <button
                        class="purchase-btn"
                        onClick="add_cart(<?php echo $bundle->getId(); ?>)">
                        Add to Cart
                    </button>
                <?php endif; ?>
            </div>
