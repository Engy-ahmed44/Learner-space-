...
class CoursesController extends Controller
{
    ...
    //        Attributes
    //-------------------------------------------------------------------------
    const IMAGES_LOCATION = "../../../../../src/main/webapp/images/logos/courses/";
    ...
    {
        if (!AuthManager::isLogged() || !$this->hasLoggedAdminAuthorization(0, 1)) {
    ...
    public function delete($idCourse)
    {
        ...
        $coursesDao = new CoursesDAO(
            $dbConnection,
            AuthManager::getLoggedIn($dbConnection)
        );
    ...
    public function setModules()
    {
        ...
        $dbConnection = MySqlPDODatabase::shared();
        $coursesDao = new CoursesDAO($dbConnection, AuthManager::getLoggedIn($dbConnection));
        $modulesDao = new ModulesDAO($dbConnection);
